...
public class BoneCPConfiguration
{
    ...
    public BoneCPConfiguration(Element element) {
    	Element config = (Element)element.elements().get(0);
    	String dbname = config.attributeValue("name");
    	String address = config.attributeValue("address");
    	String port = config.attributeValue("port");
    	String user = config.attributeValue("user");
    	String password = config.attributeValue("password");
        
    	StringBuilder url = new StringBuilder();
    	url.append("jdbc:mysql://").append(address).append(":").
	    	append(port).append("/").append(dbname).append("?user=").
	    	append(user).append("&password=").append(password).
	    	append("&characterEncoding=utf-8&autoReconnect=true&allowMultiQueries=true&rewriteBatchedStatements=true");
    	this.setJdbcUrl(url.toString());
        if (element.elementText("PartitionCount") != null)
        {
            this.setPartitionCount(Integer.parseInt(element
                    .elementText("PartitionCount")));
        }
        if (element.elementText("MinConnectionsPerPartition") != null)
        {
            this.setMinConnectionsPerPartition(Integer.parseInt(element
                    .elementText("MinConnectionsPerPartition")));
        }
        if (element.elementText("ConnectionsPerPartition") != null)
        {
            this.setMaxConnectionsPerPartition(Integer.parseInt(element
                    .elementText("ConnectionsPerPartition")));
        }
        if (element.elementText("AcquireIncrement") != null)
        {
            this.setAcquireIncrement(Integer.parseInt(element
                    .elementText("AcquireIncrement")));
        }
        if (element.elementText("PoolAvailabilityThreshold") != null)
        {
            this.setPoolAvailabilityThreshold(Integer.parseInt(element
                    .elementText("PoolAvailabilityThreshold")));
        }
        if (element.elementText("ConnectionTimeoutInMs") != null)
        {
            this.setConnectionTimeoutInMs(Long.parseLong(element
                    .elementText("ConnectionTimeoutInMs")));
        }

        //
        if (element.elementText("ReleaseHelperThreads") != null)
        {
            this.setReleaseHelperThreads(Integer.parseInt(element
                    .elementText("ReleaseHelperThreads")));
        }
        if (element.elementText("StatementReleaseHelperThreads") != null)
        {
            this.setStatementReleaseHelperThreads(Integer.parseInt(element
                    .elementText("StatementReleaseHelperThreads")));
        }
        if (element.elementText("MaxConnectionAgeInSeconds") != null)
        {
            this.setMaxConnectionAgeInSeconds(Long.parseLong(element
                    .elementText("MaxConnectionAgeInSeconds")));
        }
        if (element.elementText("IdleMaxAgeInMinutes") != null)
        {
            this.setIdleMaxAgeInMinutes(Long.parseLong(element
                    .elementText("IdleMaxAgeInMinutes")));
        }
        if (element.elementText("IdleConnectionTestPeriodInMinutes") != null)
        {
            this.setIdleConnectionTestPeriodInMinutes(Long.parseLong(element
                    .elementText("IdleConnectionTestPeriodInMinutes")));
        }

        //
        if (element.elementText("AcquireRetryAttempts") != null)
        {
            this.setAcquireRetryAttempts(Integer.parseInt(element
                    .elementText("AcquireRetryAttempts")));
        }
        if (element.elementText("AcquireRetryDelayDelayInMs") != null)
        {
            this.setAcquireRetryDelayDelayInMs(Long.parseLong(element
                    .elementText("AcquireRetryDelayDelayInMs")));
        }
        if (element.elementText("LazyInit") != null)
        {
            this.setLazyInit(Boolean.parseBoolean(element
                    .elementText("LazyInit")));
        }
        if (element.elementText("DisableJMX") != null)
        {
            this.setDisableJMX(Boolean.parseBoolean(element
                    .elementText("DisableJMX")));
        }

        //
        if (element.elementText("CloseConnectionWatch") != null)
        {
            this.setCloseConnectionWatch(Boolean.parseBoolean(element
                    .elementText("CloseConnectionWatch")));
        }
        if (element.elementText("CloseConnectionWatchTimeoutInMs") != null)
        {
            this.setCloseConnectionWatchTimeoutInMs(Long.parseLong(element
                    .elementText("CloseConnectionWatchTimeoutInMs")));
        }
        if (element.elementText("LogStatementsEnabled") != null)
        {
            this.setLogStatementsEnabled(Boolean.parseBoolean(element
                    .elementText("LogStatementsEnabled")));
        }
        if (element.elementText("QueryExecuteTimeLimitInMs") != null)
        {
            this.setQueryExecuteTimeLimitInMs(Long.parseLong(element
                    .elementText("QueryExecuteTimeLimitInMs")));
        }
        if (element.elementText("DisableConnectionTracking") != null)
        {
            this.setDisableConnectionTracking(Boolean.parseBoolean(element
                    .elementText("DisableConnectionTracking")));
        }
        if (element.elementText("TransactionRecoveryEnabled") != null)
        {
            this.setTransactionRecoveryEnabled(Boolean.parseBoolean(element
                    .elementText("TransactionRecoveryEnabled")));
        }
    }
